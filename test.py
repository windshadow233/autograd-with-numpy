...
rnn = nn.RNN(3, 4, 2, use_bias=False, batch_first=True)
...
rnn.weight_ih_l1 = nn.Parameter(nptorch.array([[-0.3465, -0.2583, 0.2262, 0.2011],
                                               [-0.2962, 0.1511, 0.2745, -0.0631],
                                               [0.0191, 0.1159, 0.3102, 0.4801],
                                               [-0.3853, -0.1832, 0.1965, 0.4143]]))
rnn.weight_hh_l1 = nn.Parameter(nptorch.array([[0.4351, 0.4412, 0.0995, -0.4348],
